...
M.winbar_filetype_exclude = {
  ...
  "Outline", "spectre_panel", "toggleterm", "DressingSelect", "Jaq", "harpoon", "dapui_scopes",
  "dapui_breakpoints", "dapui_stacks", "dapui_watches", "dap-repl", "dap-terminal", "dapui_console",
  "lab", "Markdown", ""
}
  ...
  if vim.fn.has "nvim-0.8" == 1 then
    vim.api.nvim_create_autocmd({
      ...
      callback = function()
        ...
        if not status_ok then require("user.winbar").get_winbar() end
      end
    })
  end
end
